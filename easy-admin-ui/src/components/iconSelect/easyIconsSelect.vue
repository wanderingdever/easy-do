      ...
      <div class="icon-selector-warp">
        ...
        <el-tabs v-model="state.fontIconTabActive" @tab-click="onIconClick">
          <el-tab-pane lazy label="ele" name="ele">
            <easy-icon-list :list="fontIconSheetsFilterList" :empty="emptyDescription" :prefix="state.fontIconPrefix"
                            @get-icon="onColClick"/>
          </el-tab-pane>
...
import EasyIconList from '@/components/iconSelect/easyIconList.vue'
...
// 初始化数据
async function initFontIconData(name: string) {
  if (name === 'ele') {
    // element plus 图标
...
// 图标点击切换
function onIconClick(pane: TabsPaneContext) {
