...
public class StringUtils extends StrUtil {
    ...
    public static boolean matches(String str, String pattern) {
        ...
        do {
            formerStarOffset = org.apache.commons.lang3.StringUtils.indexOf(pattern, START, beginOffset);
            prefixPattern =
            ...
            if (!isEmpty(prefixPattern)) {
                remainingURI = org.apache.commons.lang3.StringUtils.substringAfter(str, prefixPattern);
            }

            // 匹配后缀Pattern
            latterStarOffset = org.apache.commons.lang3.StringUtils.indexOf(pattern, START, formerStarOffset + 1);
            suffixPattern =
            ...
            if (!isEmpty(suffixPattern)) {
                remainingURI = org.apache.commons.lang3.StringUtils.substringAfter(str, suffixPattern);
            }
