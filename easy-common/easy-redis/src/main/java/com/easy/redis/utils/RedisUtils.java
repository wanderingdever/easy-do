...
public class RedisUtils {
     ...
     */
    public static <T> void setCacheObjectWithExpireTime(final String key, final T value, final LocalDateTime expirationTime) {
        long millisUntilExpiration = ChronoUnit.MILLIS.between(LocalDateTime.now(), expirationTime);
        setCacheObject(key, value, Duration.ofMillis(millisUntilExpiration));
    }
     ...
     * @return 缓存的对象
     */
    public static <T> boolean setCacheNewList(final String key, final List<T> dataList) {
        RList<T> rList = CLIENT.getList(key);
        rList.clear();
        return rList.addAll(dataList);
    }
    ...
    public static Collection<String> keys(final String pattern) {
        Iterable<String> stream = CLIENT.getKeys().getKeys(KeysScanOptions.defaults().pattern(pattern));
