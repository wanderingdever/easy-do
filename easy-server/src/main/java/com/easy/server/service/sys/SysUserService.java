...
import com.easy.server.bean.dto.sys.user.UserDTO;
import com.easy.server.bean.dto.sys.user.UserEditDTO;
import com.easy.server.bean.dto.sys.user.UserPwdDTO;
import com.easy.server.bean.dto.sys.user.UserSearchDTO;
import com.easy.server.bean.entity.sys.*;
import com.easy.server.bean.vo.sys.UserRoleAndPermissionVO;
import com.easy.server.bean.vo.sys.user.UserExpandVO;
import com.easy.server.bean.vo.sys.user.UserVO;
import com.easy.server.dao.sys.SysUserMapper;
