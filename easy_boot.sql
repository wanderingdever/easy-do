...
) ENGINE=InnoDB AUTO_INCREMENT=18 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统参数配置';
...
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (6, '测试1', '测试1', '1', 1, 1, '2025-08-19 16:02:33.000', '2025-08-19 16:02:33.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (9, '测试1', '22', '222', 1, 1, '2025-08-19 16:05:38.000', '2025-08-19 16:05:38.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (10, '测试333', '33', '33', 1, 1, '2025-08-19 16:05:42.000', '2025-08-19 16:05:42.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (11, '测试22112', '3213', '123123', 1, 1, '2025-08-19 16:05:47.000', '2025-08-19 16:05:47.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (12, '测3431243', '434324', '434', 1, 1, '2025-08-19 16:05:52.000', '2025-08-19 16:05:52.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (13, '434234', '4234234', '23423', 1, 1, '2025-08-19 16:05:57.000', '2025-08-19 16:05:57.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (14, '的发生地方', 's\'da\'fa\'d\'f', ' 阿道夫a', 1, 1, '2025-08-19 16:06:01.000', '2025-08-19 16:06:01.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (15, '发的发的发', '阿道夫啊', '阿凡达顺丰', 1, 1, '2025-08-19 16:06:06.000', '2025-08-19 16:06:06.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (16, '发的发发的', '发的发', '发生的发生', 0, 1, '2025-08-19 16:06:14.000', '2025-09-25 17:08:39.000');
INSERT INTO `sys_config` (`id`, `config_name`, `config_key`, `config_value`, `is_system`, `enable`, `create_time`,
                          `update_time`)
VALUES (17, '测试200', '200', '200', 1, 1, '2025-08-19 16:06:29.000', '2025-08-19 16:06:29.000');
COMMIT;
...
(
    ...
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=65 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='系统访问记录';
...
(
    ...
    `update_time`   datetime(3) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=22 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='菜单权限信息';
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_type`, `parent_id`, `order_num`, `path`, `component`, `redirect`,
                        `is_iframe`, `is_link`, `is_affix`, `is_keep_alive`, `is_hide`, `link`, `perms`, `icon`,
                        `enable`, `create_time`, `update_time`)
VALUES (3, '菜单配置', 'PAGE', 2, 1, 'system/menu', 'system/menu/menu', NULL, 0, 0, 1, 1, 0, '0', 'system.menu.tree',
        'ele-Memo', 1, NULL, '2025-09-30 11:23:08.329');
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_type`, `parent_id`, `order_num`, `path`, `component`, `redirect`,
                        `is_iframe`, `is_link`, `is_affix`, `is_keep_alive`, `is_hide`, `link`, `perms`, `icon`,
                        `enable`, `create_time`, `update_time`)
VALUES (4, '参数配置', 'PAGE', 2, 7, 'system/config', 'system/config/config', NULL, 0, 0, 0, 1, 0, '0',
        'system.config.page', 'ele-Operation', 1, NULL, '2025-08-22 16:30:12.632');
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_type`, `parent_id`, `order_num`, `path`, `component`, `redirect`,
                        `is_iframe`, `is_link`, `is_affix`, `is_keep_alive`, `is_hide`, `link`, `perms`, `icon`,
                        `enable`, `create_time`, `update_time`)
...
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_type`, `parent_id`, `order_num`, `path`, `component`, `redirect`,
                        `is_iframe`, `is_link`, `is_affix`, `is_keep_alive`, `is_hide`, `link`, `perms`, `icon`,
                        `enable`, `create_time`, `update_time`)
VALUES (6, '字典数据', 'PAGE', 2, 6, 'system/dict_data', 'system/dict/dictData', NULL, 0, 0, 0, 1, 1, '0',
        'system.dict.page', 'ele-Tickets', 1, NULL, '2025-09-16 15:59:38.000');
INSERT INTO `sys_menu` (`id`, `menu_name`, `menu_type`, `parent_id`, `order_num`, `path`, `component`, `redirect`,
                        `is_iframe`, `is_link`, `is_affix`, `is_keep_alive`, `is_hide`, `link`, `perms`, `icon`,
                        `enable`, `create_time`, `update_time`)
...
(
    ...
    `update_time`     datetime(3) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色信息';
...
INSERT INTO `sys_role` (`id`, `role_name`, `role_key`, `authority_level`, `role_sort`, `enable`, `create_time`,
                        `update_time`)
VALUES (1, '超级管理员', 'admin', 'LOWER', 1, 1, NULL, '2025-09-16 15:13:54.000');
COMMIT;
...
(
    ...
    `update_time` datetime(3) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=32 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='角色->菜单权限关联表';
...
VALUES (22, 1, 1, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (23, 1, 2, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (24, 1, 3, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (25, 1, 15, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (26, 1, 16, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (27, 1, 17, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (28, 1, 14, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (29, 1, 5, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (30, 1, 6, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
INSERT INTO `sys_role_menu` (`id`, `role_id`, `menu_id`, `create_time`, `update_time`)
VALUES (31, 1, 4, '2025-09-16 15:13:54.000', '2025-09-16 15:13:54.000');
COMMIT;
...
VALUES (1, 'admin', '$2a$10$.OjL/.***REMOVE_SECRET***', '',
        '***REMOVE_SECRET***', 'ADMIN', 'NORMAL', '2025-07-31 16:59:39.000', '2025-09-18 14:52:58.000',
        181, 1234);
INSERT INTO `sys_user` (`id`, `username`, `password`, `email`, `phone`, `client`, `status`, `create_time`,
                        `update_time`, `phone_prefix`, `phone_suffix`)
VALUES (2, 'test', '$2a$10$g/***REMOVE_SECRET***.O/NaMqsvyLnBSBO', NULL,
        '***REMOVE_SECRET***', 'WEB', 'NORMAL', '2025-09-17 16:24:02.000', '2025-09-23 14:39:12.000', 181,
        7194);
COMMIT;
...
INSERT INTO `sys_user_info` (`id`, `user_id`, `nickname`, `avatar`, `sex`, `create_time`, `update_time`)
VALUES (2, 2, '测试', NULL, '0', '2025-09-17 16:24:02.000', '2025-09-23 14:39:13.000');
COMMIT;
...
(
    ...
    `update_time` datetime(3) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户->机构关联';
...
INSERT INTO `sys_user_org` (`id`, `user_id`, `org_id`, `create_time`, `update_time`)
VALUES (11, 2, 1, '2025-09-23 14:39:13.000', '2025-09-23 14:39:13.000');
COMMIT;
...
(
    ...
    `update_time` datetime(3) DEFAULT NULL ON UPDATE CURRENT_TIMESTAMP(3) COMMENT '修改时间',
    PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='用户->角色关联';
