...
import com.easy.start.service.DictTypeService;
...
public class DictTypeController {
    ...
    @SaCheckPermission(value = "system.dict.page", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(value = "system.dict.add", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(value = "system.dict.update", orRole = Constants.ADMIN_ROLE)
    ...
    @SaCheckPermission(value = "system.dict.del", orRole = Constants.ADMIN_ROLE)
